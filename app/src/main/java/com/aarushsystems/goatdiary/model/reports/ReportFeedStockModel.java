...
public class ReportFeedStockModel implements Comparable<ReportFeedStockModel> {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (!(obj instanceof ReportFeedStockModel)) {
            return false;
        }
        ReportFeedStockModel rm = (ReportFeedStockModel) obj;
        Log.i("CUSTOM","equals = "+this.date+" - "+rm.getDate());
        return this.date.equals(rm.getDate());
    }*/

    @Override
    public int compareTo(ReportFeedStockModel o) {
